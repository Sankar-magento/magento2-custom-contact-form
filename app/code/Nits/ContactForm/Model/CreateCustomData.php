...
class CreateCustomData
{
    ...
    public function __construct(
        ...
        $this->createCustomContact = $storeInterfaceFactory;
    }
    ...
    {
        if (!isset($data[DataInterface::FIRSTNAME])) {
            throw new LocalizedException(__('First Name must be set'));
        }
        if (!isset($data[DataInterface::LASTNAME])) {
            throw new LocalizedException(__('Last Name must be set'));
        }
    ...
    private function createContact(array $data): DataInterface
    {
        ...
        $model = $this->createCustomContact->create();
